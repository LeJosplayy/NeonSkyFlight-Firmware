...
//#define MPU3050
   ...
   //   #define BMP085
     ...
     //  #define FORCE_GYRO_ORIENTATION(X, Y, Z) {imu.gyroADC[PITCH] = Y; imu.gyroADC[ROLL] =  X; imu.gyroADC[YAW] = Z;}
    ...
    /****************************    PPM Sum Reciver    ***********************************/
     ...
     // #define SERIAL_SUM_PPM         PITCH,YAW,THROTTLE,ROLL,AUX1,AUX2,AUX3,AUX4 //For Graupner/Spektrum
      ...
      //#define SERIAL_SUM_PPM         PITCH,ROLL,THROTTLE,YAW,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //For some Hitec/Sanwa/Others
       #define SERIAL_SUM_PPM THROTTLE,YAW,PITCH,ROLL,AUX1,AUX2,AUX3,AUX4,8,9,10,11 // LeJosplayy
...
#define VBAT              // uncomment this line to activate the vbat code
    ...
    #define VBAT_OFFSET       28 // offset in 0.1Volts, gets added to voltage value  - useful for zener diodes
